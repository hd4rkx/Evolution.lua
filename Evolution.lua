getgenv().Evolution = {
    ...
    ["Silent Aim"] = {
        ...
        ["Prediction"] = 0.14253, -- // Prediction Value
...
GetPrediction = function() 
    if Evolution["Global"]["Auto Prediction"].Enabled then 
	    ...
	    if PingNumber < 30 then
            ...
            elseif PingNumber < 270 then
                return 0.2661742
            elseif PingNumber < 280 then
                return 0.2723288
            elseif PingNumber < 290 then
                return 0.2784834
